import type { AgentWithSubagents, UpdateAgentDTO } from '@domain/entities/agent.entity.js'
...
export class UpdateAgentUseCase {
	...
	async execute(input: UpdateAgentDTO): Promise<{ success: true; data: AgentWithSubagents } | { success: false; error: string }> {
		try {

import type { AgentWithSubagents, CreateAgentDTO } from '@domain/entities/agent.entity.js'
...
export class CreateAgentUseCase {
	...
	async execute(input: CreateAgentDTO): Promise<{ success: true; data: AgentWithSubagents } | { success: false; error: string }> {
		try {

...
} from "./application/routes/mcp.route.js";
...
async function startServers() {
	console.log("🚀 Starting Clarify Servers...\n");
  ...
  mcpApp.use(cors({
	...
	apiHttpServer.listen(API_PORT, () => {
		...
		console.log("═══════════════════════════════════════════");
		console.log(
			`✅ Clarify API Server running on http://localhost:${API_PORT}`,
		);
		console.log("═══════════════════════════════════════════");
		console.log("");
	...
	mcpHttpServer.listen(MCP_PORT, () => {
		...
		console.log("═══════════════════════════════════════════");
		console.log(
			`✅ Clarify MCP Server running on http://localhost:${MCP_PORT}`,
		);
		console.log("═══════════════════════════════════════════");
		console.log("");
		console.log("Endpoints:");
		console.log(
			`  🤖 MCP:       http://localhost:${MCP_PORT}/mcp (Streamable HTTP)`,
		);
		console.log(`  📋 MCP Tools: http://localhost:${MCP_PORT}/mcp/tools`);
		console.log(`  📝 Prompts:   http://localhost:${MCP_PORT}/mcp/prompts`);
		console.log(
			`  🔐 OAuth:     http://localhost:${MCP_PORT}/.well-known/oauth-authorization-server`,
		);
		console.log("");
	...
	mcpExternalManager
		...
		.catch((err) => {
			console.error(
				"⚠️  MCP External Manager failed to initialize:",
				err.message,
			);
		});

...
const allTabs = [
  { key: 'users', label: 'Users', icon: 'mdi-account', resource: 'users', component: UsersView },
  { key: 'roles', label: 'Roles', icon: 'mdi-shield-account', resource: 'roles', component: RolesView },
]

...
const allSections = [
  ...
  },
  {
    ...
    label: 'Trazabilidad',
    description:
      'Gestiona el ciclo de vida completo de tus flujos de trabajo mediante templates con etapas configurables, tareas por nodo, links a Jira/GitHub y seguimiento automático de estado.',
    gradient: 'from-teal-500 to-cyan-600',
    glow: 'shadow-teal-500/20',
    badge: 'bg-teal-500/10 text-teal-400 ring-1 ring-teal-500/20',
    icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" />`,
  },
]

const sections = computed(() =>
  allSections.filter((s) => s.resource === null || auth.hasResourceAccess(s.resource))
)
</script>

    ...
    <div class="w-80 shrink-0 border-r border-base-300/60 flex flex-col min-h-0 overflow-auto">
      <div class="p-5">
        <button v-if="auth.hasPermission('governance', 'create')"
          class="w-full p-2 rounded-lg bg-violet-600 hover:bg-violet-500 text-white text-sm font-medium transition-colors"
          @click="openCreate">
      ...
      <div class="space-y-3">
        <div class="flex items-center justify-between gap-3">
          <div>
            ...
            <p class="text-xs text-base-content/40">Estructura opcional para que el agente consulte la gobernanza por
              bloques.
            </p>
          </div>
          <button type="button"

...
<template>
  ...
  <AppModal v-if="rolesModalUser" size="sm" :scroll-body="false" :title="rolesModalUser.username"
    ...
    <div class="p-2">
      ...
      <div v-else class="space-y-2">
        <div v-for="role in allRoles" :key="role.id"
          class="flex items-center gap-3 p-3 rounded-lg hover:bg-base-300 transition-colors cursor-pointer"
